 ...
 Author List :      Bittu Chauhan
 Filename:          dij.cpp
 Theme:             Search and Rescue
 Functions:         rem,shortest_path
 Global Variables:	dist1,dist,path,original,n,tot
 */ 
#define MAX_NODES 200
#define INFINITE 9999
unsigned int n=MAX_NODES;
int dist[163][2]={{1,2},{1,11},{2,1},{2,3},{3,2},{3,4},{3,13},{4,3},{4,5},{5,4},{5,6},{5,15},{6,5},{6,7},{7,6},{7,8},
	...
	{81,71},{81,82},{82,81},{82,83},{83,82},{83,84},{83,73},{84,83},{84,85},{85,84},{85,86},{85,75},
	{86,85},{86,87},{87,86},{87,88},{87,77},{88,87},{88,89},{89,88},{89,79}
	};   //map of arena
